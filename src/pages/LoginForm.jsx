...
function LoginForm() {
  ...
  const handleForgotPasswordSuccess = () => {
    setShowForgotPassword(false); // Close modal on successful form submission
  };
      ...
      <div className="flex flex-col mx-auto justify-center gap-3">
        ...
        <form className="flex flex-col" onSubmit={hdlSubmit}>
          ...
          <div className="flex items-center justify-between pt-5">
            <button
              type="submit"
              className="btn transition ease-in-out delay-150 bg-red-500 hover:-translate-y-1 hover:scale-110 hover:bg-red-400 duration-300 text-white"
            >
              Login
            </button>
            <a
