...
import { useShopCart } from '@/src/contexts/ShopCard-context/ShopCart'
import ShopCardList from './../../components/ShopCard/ShopCardList';
import ShopCardPay from '@/src/components/ShopCard/ShopCardPay';

export default function ShopCard() {
    const { orderUser,getOrderId, hdlDelete, calculateTotalPrice } = useShopCart();
        ...
        <div className='container mx-auto px-16'>
            ...
            <div className="container mx-auto mt-2 min-h-full flex justify-between bg-white">
                <div className="flex-col w-3/5">
                    <ShopCardList orderUser={orderUser} hdlDelete={hdlDelete} getOrderId={getOrderId} />
                </div>
